...
**Key Prediction:** We expect an **10-song setlist** running approximately **12:59** in a medley format, featuring a mix of classic hits and new material from "Debí Tirar Más Fotos" (2025).
...
- **BAILE INoLVIDABLE** — Appeared in Apple Music halftime trailer

---

## Predicted Setlists

### 🎯 Conservative (8 songs)
*Highest confidence picks only*

**Runtime:** 10:51 | **Confidence:** 97%

| # | Song | Duration | Confidence | Notes |
|---|------|----------|------------|-------|
| 1 | BAILE INoLVIDABLE | 2:00 | 100% | ✅ Confirmed, 🆕 New Album |
...
### 🚀 Expansive (12 songs)
*Full medley format like Usher (2024)*
...
|------|-------|-------------------|------------------|
| El apagón | 93% | 76 | Lower ensemble score than selected songs |
| Si veo a tu mamá | 93% | 94 | Lower ensemble score than selected songs |
| Efecto | 92% | 99 | Lower ensemble score than selected songs |
| Tú no metes cabra | 89% | 74 | Lower ensemble score than selected songs |
| PIToRRO DE COCO | 89% | 39 | Lower ensemble score than selected songs |
| TURiSTA | 88% | 37 | Lower ensemble score than selected songs |
| Dime si te acuerdas | 88% | 50 | Lower ensemble score than selected songs |
| NI BIEN NI MAL | 87% | 52 | Lower ensemble score than selected songs |
